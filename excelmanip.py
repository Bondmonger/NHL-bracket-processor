...
current_dict, final_dict, path = {}, {}, r"D:/Hockey/NHLBrackets/2022/"


@lru_cache(maxsize=35)
def abbrev(full_name):
    full_length = {"Hurricanes": "Hur", "Blue Jackets": "Cbj", "Devils": "Dev", "Islanders": "Isl", "Rangers": "Ran",
                   "Flyers": "Fly", "Penguins": "Pen", "Capitals": "Cap", "Bruins": "Bru", "Red Wings": "Red",
                   "Panthers": "Pan", "Canadiens": "Hab", "Senators": "Sen", "Lightning": "Ltg", "Maple Leafs": "Lfs",
